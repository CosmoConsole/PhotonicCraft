...
public class ModelLaserPointer extends ModelBase
{
    public ModelRenderer l;

    public ModelLaserPointer()
    {
        ...
        this.l.addBox(-0.25F, -0.25F, -0.25F, 1, 1, 1, 0.1F);
        this.l.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.l.rotateAngleX = ((float)Math.PI / 2F);
    }
