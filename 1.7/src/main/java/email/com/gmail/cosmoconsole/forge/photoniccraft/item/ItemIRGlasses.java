...
public class ItemIRGlasses extends ItemArmor implements ISpecialArmor, IEnergyContainerItem {
	public static final int TIMER = 2400; 
	public static final int RF_PER_T = 10;
	public String textureName;

    public ItemIRGlasses(ArmorMaterial p_i45325_1_, int p_i45325_2_, int p_i45325_3_) {
        super(p_i45325_1_, p_i45325_2_, p_i45325_3_);
    }
	public ItemIRGlasses(String unlocalizedName, ArmorMaterial material, String textureName, int type) {
	...
	public void onArmorTick(World par2World, EntityPlayer par3Entity, ItemStack par1ItemStack) {
    	...
    	if (par3Entity instanceof EntityPlayer) {
    		...
    		par3Entity.addPotionEffect(new PotionEffect(Potion.nightVision.id, 5, 1, true));
    	}
	}
	@Override
