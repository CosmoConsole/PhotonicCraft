...
public class RenderLaserEffect extends Render
{
    protected ModelBase modelLaser;

    public RenderLaserEffect() {
    	this.shadowSize = 0.0F;
    	this.shadowOpaque = 0.0F;
        this.modelLaser = new ModelLaserEffect();
    }

    public void doRender(EntityLaserEffect p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        this.doRender((EntityLaserEffect)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
