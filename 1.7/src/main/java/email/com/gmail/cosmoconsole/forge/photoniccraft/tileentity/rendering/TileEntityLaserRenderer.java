...
public class TileEntityLaserRenderer extends TileEntitySpecialRenderer {
	...
	private final TileEntityLaserModel model;
    ResourceLocation textures = (new ResourceLocation("photoniccraft:textures/blocks/lasermodern.png")); 
    
    public TileEntityLaserRenderer() {
            this.model = new TileEntityLaserModel();
    }
	...
	public void renderTileEntityAt(TileEntity p_147500_1_, double x,
        ...
        GL11.glPushMatrix();
        TileEntityLaser t = (TileEntityLaser) p_147500_1_;
