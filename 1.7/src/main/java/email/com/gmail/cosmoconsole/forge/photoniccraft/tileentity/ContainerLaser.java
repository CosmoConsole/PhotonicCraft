...
public class ContainerLaser extends Container
{
    ...
    public ContainerLaser(InventoryPlayer p_i1812_1_, TileEntityLaser p_i1812_2_)
    {
        ...
        this.addSlotToContainer(new Slot(p_i1812_2_, 0, 25, 30));
        this.addSlotToContainer(new Slot(p_i1812_2_, 1, 80, 30));
        this.addSlotToContainer(new Slot(p_i1812_2_, 2, 134, 30));
        int i;
    ...
    public void addCraftingToCrafters(ICrafting p_75132_1_)
    {
        ...
        p_75132_1_.sendProgressBarUpdate(this, 0, this.tileLaser.laserBurnTime);
        p_75132_1_.sendProgressBarUpdate(this, 1, this.tileLaser.currentItemBurnTime);
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            {
                icrafting.sendProgressBarUpdate(this, 0, this.tileLaser.laserBurnTime);
            }

            if (this.lastItemBurnTime != this.tileLaser.currentItemBurnTime)
            {
                icrafting.sendProgressBarUpdate(this, 1, this.tileLaser.currentItemBurnTime);
            }
        }
