...
public class TileEntityLaserMirrorRenderer extends TileEntitySpecialRenderer {

	private ResourceLocation textures;
	private final TileEntityLaserMirrorModel model; 
    
    public TileEntityLaserMirrorRenderer(ResourceLocation t) {
    		textures = t;
            this.model = new TileEntityLaserMirrorModel();
    }
	...
	final float[] rx = {  0f,  0f,  0f,  0f,180f,180f,  0f,  0f,
						180f,180f,  0f,  0f,180f,180f,  0f,  0f};
	final float[] ry = {  0f,  0f, 90f,  0f, 90f,  0f,  0f,  0f,
						  0f,  0f,-90f,180f,-90f,180f,  0f,  0f};
