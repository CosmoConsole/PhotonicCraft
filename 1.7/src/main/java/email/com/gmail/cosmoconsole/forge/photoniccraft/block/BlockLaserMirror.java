...
public class BlockLaserMirror extends Block implements ITileEntityProvider
{
    ...
    public BlockLaserMirror()
    {
		...
		this.setBlockName(ModPhotonicCraft.MODID + "_lasermirror");
    ...
    public boolean isSideSolid(IBlockAccess world, int x, int y, int z, ForgeDirection side)
    {
    	...
    	if (m == 0 || m == 1 || m == 8 || m == 9) return (side == ForgeDirection.UP) || (side == ForgeDirection.DOWN);
    	if (m == 2 || m == 4 || m == 10 || m == 12) return (side == ForgeDirection.NORTH) || (side == ForgeDirection.SOUTH);
    	if (m == 3 || m == 5 || m == 11 || m == 13) return (side == ForgeDirection.WEST) || (side == ForgeDirection.EAST);
    	return false;
    }
    @Override
    ...
    {
    	int l = this.determineOrientation(p_149689_1_, p_149689_2_, p_149689_3_, p_149689_4_, p_149689_5_);
