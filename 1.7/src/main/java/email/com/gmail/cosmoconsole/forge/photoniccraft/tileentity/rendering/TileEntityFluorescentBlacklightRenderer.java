...
public class TileEntityFluorescentBlacklightRenderer extends TileEntitySpecialRenderer {

	private final TileEntityFluorescentLightModel model;
    ResourceLocation textures = (new ResourceLocation("photoniccraft:textures/blocks/blacklight_off.png")); 
    ResourceLocation textures_on = (new ResourceLocation("photoniccraft:textures/blocks/blacklight_on.png")); 
    
    public TileEntityFluorescentBlacklightRenderer() {
