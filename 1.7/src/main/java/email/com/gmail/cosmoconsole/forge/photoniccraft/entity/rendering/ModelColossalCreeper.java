...
public class ModelColossalCreeper extends ModelBase {
	...
	public ModelColossalCreeper()
    {
        this(0.0F);
    }

    public ModelColossalCreeper(float p_i1147_1_)
    {
        byte b0 = 4;
        float n = 40.0F;
        this.head = new ModelRenderer(this, 0, 0);
        this.head.addBox(-4.0F * n, -8.0F * n, -4.0F * n, 8, 8, 8, p_i1147_1_);
        this.head.setRotationPoint(0.0F, (float)b0, 0.0F);
        this.field_78133_b = new ModelRenderer(this, 32, 0);
        this.field_78133_b.addBox(-4.0F * n, -8.0F * n, -4.0F * n, 8, 8, 8, p_i1147_1_ + 0.5F);
        this.field_78133_b.setRotationPoint(0.0F, (float)b0, 0.0F);
        this.body = new ModelRenderer(this, 16, 16);
        this.body.addBox(-4.0F * n, 0.0F * n, -2.0F * n, 8, 12, 4, p_i1147_1_);
        this.body.setRotationPoint(0.0F, (float)b0, 0.0F);
        this.leg1 = new ModelRenderer(this, 0, 16);
        this.leg1.addBox(-2.0F * n, 0.0F * n, -2.0F * n, 4, 6, 4, p_i1147_1_);
        this.leg1.setRotationPoint(-2.0F, (float)(12 + b0), 4.0F);
        this.leg2 = new ModelRenderer(this, 0, 16);
        this.leg2.addBox(-2.0F * n, 0.0F * n, -2.0F * n, 4, 6, 4, p_i1147_1_);
        this.leg2.setRotationPoint(2.0F, (float)(12 + b0), 4.0F);
        this.leg3 = new ModelRenderer(this, 0, 16);
        this.leg3.addBox(-2.0F * n, 0.0F * n, -2.0F * n, 4, 6, 4, p_i1147_1_);
        this.leg3.setRotationPoint(-2.0F, (float)(12 + b0), -4.0F);
        this.leg4 = new ModelRenderer(this, 0, 16);
        this.leg4.addBox(-2.0F * n, 0.0F * n, -2.0F * n, 4, 6, 4, p_i1147_1_);
