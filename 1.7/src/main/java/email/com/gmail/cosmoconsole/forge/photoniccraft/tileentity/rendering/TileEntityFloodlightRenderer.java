...
public class TileEntityFloodlightRenderer extends TileEntitySpecialRenderer {

	private final TileEntityFloodlightModel model;
    ResourceLocation textures = (new ResourceLocation("photoniccraft:textures/blocks/floodlight_on.png")); 
    
    public TileEntityFloodlightRenderer() {
            this.model = new TileEntityFloodlightModel();
    }
	...
	public void renderTileEntityAt(TileEntity p_147500_1_, double x,
        ...
        GL11.glPushMatrix();
        TileEntityFloodlight t = (TileEntityFloodlight) p_147500_1_;
