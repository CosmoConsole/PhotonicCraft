...
public class BlockInfiniteSource extends Block implements ITileEntityProvider {
	public BlockInfiniteSource() {
		...
		this.setUnlocalizedName(ModPhotonicCraft.MODID + "_infiniterfsource");
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityInfiniteSource();
	}
