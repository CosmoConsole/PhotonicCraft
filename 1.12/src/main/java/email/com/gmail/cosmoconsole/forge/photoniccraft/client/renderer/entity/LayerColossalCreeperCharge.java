...
public class LayerColossalCreeperCharge implements LayerRenderer<EntityColossalCreeper> {
	private static final ResourceLocation LIGHTNING_TEXTURE = new ResourceLocation(
			"textures/entity/creeper/creeper_armor.png");
	private final RenderColossalCreeper creeperRenderer;
	private final ModelColossalCreeper creeperModel = new ModelColossalCreeper(2.0F);

	public LayerColossalCreeperCharge(RenderColossalCreeper creeperRendererIn) {
		this.creeperRenderer = creeperRendererIn;
	}

	@Override
	public void doRenderLayer(EntityColossalCreeper entitylivingbaseIn, float limbSwing, float limbSwingAmount,
