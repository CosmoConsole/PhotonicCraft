...
public class BlockFluorescentLight extends BlockHorizontal implements ITileEntityProvider {
	...
	public BlockFluorescentLight() {
		super(Material.GLASS);
		this.setHardness(5.0F);
		this.setResistance(5.0F);
		this.setSoundType(SoundType.STONE);
		this.setUnlocalizedName(ModPhotonicCraft.MODID + "_fluorescent");
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityFluorescentLight();
	}
	...
	public Item getItemDropped(IBlockState state, Random p_149650_2_, int p_149650_3_) {
		return PhotonicItems.laserItems[9];
	}
	...
	public int getLightValue(IBlockState state, IBlockAccess world, BlockPos bp) {
		try {
			...
			return ((TileEntityFluorescentLight) te).isPowered() ? 15 : 0;
		} catch (Exception ex) {
			return 0;
		}
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		worldIn.setBlockState(pos,
				state.withProperty(BlockHorizontal.FACING, PhotonicUtils.convertIntToEnumFacingForceHorizontal(
						BlockFluorescentLight.determineOrientation(worldIn, pos, placer))));
	}
