...
/**
 * The ComputerCraft IPeripheral implementation for the Radio Transmitter
 * peripheral.
 */
...
public class PeripheralRadioTransmitter implements dan200.computercraft.api.peripheral.IPeripheral {
	PhotonicLocation loc;
	int power = 20;

	public PeripheralRadioTransmitter(@Nonnull final World world, @Nonnull final BlockPos bp) {
	...
	public boolean equals(dan200.computercraft.api.peripheral.IPeripheral other) {
		return (other != null && other.getClass() == this.getClass()
				&& ((PeripheralRadioTransmitter) other).loc.equals(this.loc));
	}
	...
	public String getType() {
		return "photonicradiotransmitter";
	}
