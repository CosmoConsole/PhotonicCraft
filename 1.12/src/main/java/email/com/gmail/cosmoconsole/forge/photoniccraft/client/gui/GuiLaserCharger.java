...
public class GuiLaserCharger extends GuiContainer {
	private static final ResourceLocation laserGuiTextures = new ResourceLocation(
			"photoniccraft:textures/gui/charger.png");
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
		String s = I18n.format(ModPhotonicCraft.MODID + "_container.lasercharger", new Object[0]);
		this.fontRenderer.drawString(s, this.xSize / 2 - this.fontRenderer.getStringWidth(s) / 2, 6, 4210752);
		this.fontRenderer.drawString(this.tileLaser.input + " RF/t", 40, 45, 4210752);
