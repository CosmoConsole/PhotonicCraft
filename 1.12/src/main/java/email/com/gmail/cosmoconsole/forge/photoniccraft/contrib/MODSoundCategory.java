package email.com.gmail.cosmoconsole.forge.photoniccraft.contrib;
...
* @see http://www.minecraftforge.net/forum/topic/42439-adding-additional-soundcategorys/
*
*/
public class MODSoundCategory {
	...
	/**
	 * The "name" should be your MODID or MODID_name if your mod adds more than
	 * one SoundCategory.
	 * 
	 * @param name
	...
	public static SoundCategory add(String name) {
		...
		soundCategory = EnumHelper.addEnum(SoundCategory.class, constantName, new Class[] { String.class },
				new Object[] { referenceName });
		SOUND_CATEGORIES = ObfuscationReflectionHelper.getPrivateValue(SoundCategory.class, SoundCategory.VOICE,
				"SOUND_CATEGORIES", SRG_SOUND_CATEGORIES);
	...
	private static void setSoundLevels() {
		...
		ObfuscationReflectionHelper.setPrivateValue(GameSettings.class, Minecraft.getMinecraft().gameSettings,
				soundLevels, "soundLevels", SRG_soundLevels);
	}
